...
`AptosFormal.Move.Programs.Confidential.confidentialModuleEnv`, the Lean transcription of the
...
namespace AptosFormal.Refinement.Confidential
...
end AptosFormal.Refinement.Confidential
