...
namespace AptosFormal.Std.Error
...
def canonical_native : List AptosFormal.Move.MoveValue → Option (List AptosFormal.Move.MoveValue)
  | [.u64 cat, .u64 r] => some [.u64 (canonical cat r)]
  | _ => none
