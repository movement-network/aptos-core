import MovementFormal.DiffTest.JsonParser
...
/-! ## Main (`lake exe difftest`)

Lake links `_root_.main` from this module; keep it **outside** `namespace MovementFormal.DiffTest`.
-/

open MovementFormal.DiffTest
