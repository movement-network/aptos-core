...
private theorem registrationCsAfterAppendToken_lt4_store
    (mv sOpt : MoveValue) (chainId : UInt8) (sender contract token : ByteArray) :
...
private theorem registrationCsAfterAppendPubkeyBytes_write_eq
    (mv sOpt : MoveValue) (chainId : UInt8) (sender contract token : ByteArray) (ekBytesList : List MoveValue) :
...
private theorem registrationCsAfterAppendPubkeyBytes_lt4_store
    (mv sOpt : MoveValue) (chainId : UInt8) (sender contract token : ByteArray) (ekBytesList : List MoveValue) :
...
private theorem registrationCsAfterAppendCompressedPointBytes_write_eq
    (mv sOpt : MoveValue) (chainId : UInt8) (sender contract token : ByteArray) (ekBytesList rcBytesList : List MoveValue) :
...
private theorem registrationCsAfterAppendCompressedPointBytes_read4
    (mv sOpt : MoveValue) (chainId : UInt8) (sender contract token : ByteArray) (ekBytesList rcBytesList : List MoveValue) :
...
private theorem registration_ms_pc55_abstract_output_eq_pointMulSH
    (mv sOpt : MoveValue) (chainId : UInt8) (sender contract token : ByteArray) (ekBytesList rcBytesList : List MoveValue)
...
private theorem registration_ms_pc59_abstract_output_eq_pointMulEkE
    (mv sOpt : MoveValue) (chainId : UInt8) (sender contract token : ByteArray) (ekBytesList rcBytesList : List MoveValue)
...
private theorem registration_ms_pointMulEkE_read_hsPt
    (mv sOpt : MoveValue) (chainId : UInt8) (sender contract token : ByteArray) (ekBytesList rcBytesList : List MoveValue)
    (hPoint sVal hsPt ekPt eScalar : MoveValue) :
    (registrationMsAfterPointMulEkE mv sOpt chainId sender contract token ekBytesList rcBytesList hPoint sVal hsPt ekPt
...
private theorem registration_ms_pc63_abstract_output_eq_pointAddLhs
    (mv sOpt : MoveValue) (chainId : UInt8) (sender contract token : ByteArray) (ekBytesList rcBytesList : List MoveValue)
...
private theorem registration_ms_pc66_abstract_output_eq_decompressRhs
    (mv sOpt : MoveValue) (chainId : UInt8) (sender contract token : ByteArray) (ekBytesList rcBytesList : List MoveValue)
...
private theorem registration_ms_returned_abstract_output_eq
    (mv sOpt : MoveValue) (chainId : UInt8) (sender contract token : ByteArray) (ekBytesList rcBytesList : List MoveValue)
    (rCompressed hPoint sVal hsPt ekPt eScalar ekePt lhsPt rhsPt : MoveValue) :
    { (registrationMsAfterPointDecompressRhs mv sOpt chainId sender contract token ekBytesList rcBytesList rCompressed hPoint
