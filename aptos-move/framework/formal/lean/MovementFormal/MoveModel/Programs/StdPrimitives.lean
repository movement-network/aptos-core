...
namespace MovementFormal.MoveModel.Programs.StdPrimitives
...
def mkErrCode (cat : UInt64) : Array MoveInstr := #[
...
def mkErrDesc (cat : UInt64) : FuncDesc :=
...
end MovementFormal.MoveModel.Programs.StdPrimitives
