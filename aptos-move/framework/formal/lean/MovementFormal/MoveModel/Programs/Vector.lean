...
namespace MovementFormal.MoveModel.Programs.Vector
...
relative to the module environment — see `MoveModel/Programs.lean` for the
index table. -/
...
`MoveModel/Programs.lean` for the index table. -/
...
end MovementFormal.MoveModel.Programs.Vector
