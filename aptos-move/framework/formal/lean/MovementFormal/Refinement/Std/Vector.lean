...
import MovementFormal.Std.Vector.Operations
...
Smokes: `MovementFormal.SmokeTests.Vector` (`native_decide` on concrete inputs).
-/

namespace MovementFormal.Refinement.Std.Vector
...
open MovementFormal.Std.Vector
