...
lean_lib «MovementFormal» where
  roots := #[
    ...
    `MovementFormal.Experimental.ConfidentialAsset.Registration.ConcreteExecutionLemmas,
    `MovementFormal.Experimental.ConfidentialAsset.Registration.OracleCorrespondenceProofs,
    ...
    `MovementFormal.Experimental.ConfidentialAsset.Registration.GlobalStateInvariants,
    `MovementFormal.Experimental.ConfidentialAsset.Registration.InstructionEffectCatalog,
    `MovementFormal.Experimental.ConfidentialAsset.Registration.BytecodeSemanticsCatalog,
    `MovementFormal.Experimental.ConfidentialAsset.Registration.ProofCompositionPatterns,
    ...
    `MovementFormal.Experimental.ConfidentialAsset.Registration.ConcreteValueFlowAnalysis,
    `MovementFormal.Experimental.ConfidentialAsset.Registration.PCChainProofs,
    ...
    `MovementFormal.Experimental.ConfidentialAsset.Registration.ErrorPathAnalysisComplete,
    ...
    `MovementFormal.Experimental.ConfidentialAsset.Registration.CompleteProofAssembly,
    `MovementFormal.Experimental.ConfidentialAsset.Registration.ProofValidationFramework,
    `MovementFormal.Experimental.ConfidentialAsset.Registration.BytecodeTranscriptionComplete,
    `MovementFormal.Experimental.ConfidentialAsset.Registration.OracleInteractionPatterns,
    ...
    `MovementFormal.Experimental.ConfidentialAsset.Registration.PhaseBoundaryVerification,
    `MovementFormal.Experimental.ConfidentialAsset.Registration.MemorySafetyComplete,
    `MovementFormal.Experimental.ConfidentialAsset.Registration.ValueValidationComplete,
    `MovementFormal.Experimental.ConfidentialAsset.Registration.ContainerInteractionComplete,
    ...
    `MovementFormal.Experimental.ConfidentialAsset.Registration.CompleteInvariantSystem,
    `MovementFormal.Experimental.ConfidentialAsset.Registration.VerificationStatusSummary,
    `MovementFormal.Experimental.ConfidentialAsset.Registration.Phase1PCProofs,
    `MovementFormal.Experimental.ConfidentialAsset.Registration.Phase2PCProofs,
    `MovementFormal.Experimental.ConfidentialAsset.Registration.Phase3PCProofs,
    `MovementFormal.Experimental.ConfidentialAsset.Registration.PCProofImplementations,
    `MovementFormal.Experimental.ConfidentialAsset.Registration.PhaseCompositionProofs,
    `MovementFormal.Experimental.ConfidentialAsset.Registration.RunCompositionLemmas,
    `MovementFormal.Experimental.ConfidentialAsset.Registration.ProofAutomationTactics,
    `MovementFormal.Experimental.ConfidentialAsset.Registration.WitnessExtraction,
    `MovementFormal.Experimental.ConfidentialAsset.Registration.ConcreteProofInstances,
    `MovementFormal.Experimental.ConfidentialAsset.Registration.InstructionEncodingVerification,
    ...
    `MovementFormal.Experimental.ConfidentialAsset.Registration.PC4_10_Implementations,
    `MovementFormal.Experimental.ConfidentialAsset.Registration.PC11_20_Implementations,
    `MovementFormal.Experimental.ConfidentialAsset.Registration.PC20_30_Implementations,
    `MovementFormal.Experimental.ConfidentialAsset.Registration.PC31_43_Implementations,
    `MovementFormal.Experimental.ConfidentialAsset.Registration.PC43_55_Implementations,
    `MovementFormal.Experimental.ConfidentialAsset.Registration.PC56_70_Implementations,
    `MovementFormal.Experimental.ConfidentialAsset.Registration.ArrayLemmas,
    `MovementFormal.Experimental.ConfidentialAsset.Registration.PCProofChaining,
    `MovementFormal.Experimental.ConfidentialAsset.Registration.PC4_10_Composition,
    `MovementFormal.Experimental.ConfidentialAsset.Registration.PC10_16_Composition,
    `MovementFormal.Experimental.ConfidentialAsset.Registration.PC16_20_Composition,
    `MovementFormal.Experimental.ConfidentialAsset.Registration.Phase1Complete,
    `MovementFormal.Experimental.ConfidentialAsset.Registration.PC20_30_Composition,
    `MovementFormal.Experimental.ConfidentialAsset.Registration.PC31_43_Composition,
    `MovementFormal.Experimental.ConfidentialAsset.Registration.Phase2Complete,
    ...
    `MovementFormal.MoveModel.Programs.RegistrationHelpers,
