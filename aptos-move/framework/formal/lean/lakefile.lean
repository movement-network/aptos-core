...
lean_lib «MovementFormal» where
  roots := #[
    ...
    `MovementFormal.Experimental.ConfidentialAsset.Registration.NativeCallPatterns,
    `MovementFormal.Experimental.ConfidentialAsset.Registration.BytecodeTranscriptionLemmas,
    `MovementFormal.Experimental.ConfidentialAsset.Registration.RefIdManagementLemmas,
    `MovementFormal.Experimental.ConfidentialAsset.Registration.ModuleEnvProperties,
    `MovementFormal.Experimental.ConfidentialAsset.Registration.ExecutionTraceProperties,
    `MovementFormal.Experimental.ConfidentialAsset.Registration.StateTransitionLemmas,
    `MovementFormal.Experimental.ConfidentialAsset.Registration.CompositeInstructionPatterns,
    ...
    `MovementFormal.Experimental.ConfidentialAsset.Registration.ValueTypePreservation,
