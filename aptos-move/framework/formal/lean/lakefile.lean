...
lean_lib «MovementFormal» where
  roots := #[
    ...
    `MovementFormal.Experimental.ConfidentialAsset.Registration.PC11_20_Implementations,    `MovementFormal.Experimental.ConfidentialAsset.Registration.Phase6Composition,
