...
// These replace previous Rust-level panics inside algebra natives so that
// malformed inputs or unreachable branches surface as clean Move aborts
// rather than taking the VM down.
pub(crate) const E_ALGEBRA_BLS12_381_GT_GEN_UNAVAILABLE: u64 = 0x0A_0001;
pub(crate) const E_ALGEBRA_BLS12_381_R_BYTES_UNAVAILABLE: u64 = 0x0A_0002;
pub(crate) const E_ALGEBRA_BLS12_381_R_SCALAR_UNAVAILABLE: u64 = 0x0A_0003;
pub(crate) const E_ALGEBRA_BLS12_381_Q12_BYTES_UNAVAILABLE: u64 = 0x0A_0004;
pub(crate) const E_ALGEBRA_BN254_GT_GEN_UNAVAILABLE: u64 = 0x0A_0005;
pub(crate) const E_ALGEBRA_BN254_Q12_BYTES_UNAVAILABLE: u64 = 0x0A_0006;
pub(crate) const E_ALGEBRA_MSM_WINDOW_SIZE_ZERO: u64 = 0x0A_0007;
pub(crate) const E_ALGEBRA_MSM_FAILED: u64 = 0x0A_0008;
pub(crate) const E_ALGEBRA_H2C_G1_MAPPER_INIT_FAILED: u64 = 0x0A_0009;
pub(crate) const E_ALGEBRA_H2C_G1_MAP_FAILED: u64 = 0x0A_000A;
pub(crate) const E_ALGEBRA_H2C_G2_MAPPER_INIT_FAILED: u64 = 0x0A_000B;
pub(crate) const E_ALGEBRA_H2C_G2_MAP_FAILED: u64 = 0x0A_000C;
#[allow(dead_code)]
pub(crate) const E_ALGEBRA_RAND_STRUCTURE_UNSUPPORTED: u64 = 0x0A_000D;
...
// Each of the fallible constants below used to panic at first-use if its hex
// string or ark-serialization failed to parse. That would take the VM down
// from a native call site. We now surface the failure as `None` and let every
// consumer map it to a structured Move abort.

pub(crate) static BLS12381_GT_GENERATOR: Lazy<Option<ark_bls12_381::Fq12>> = Lazy::new(|| {
...
pub(crate) static BLS12381_R_LENDIAN: Lazy<Option<Vec<u8>>> = Lazy::new(|| {
    hex::decode("01000000fffffffffe5bfeff02a4bd5305d8a10908d83933487d9d2953a7ed73").ok()
});

pub(crate) static BLS12381_R_SCALAR: Lazy<Option<ark_ff::BigInteger256>> = Lazy::new(|| {
    let bytes = BLS12381_R_LENDIAN.as_ref()?;
    ark_ff::BigInteger256::deserialize_uncompressed(bytes.as_slice()).ok()
});

pub(crate) static BLS12381_Q12_LENDIAN: Lazy<Option<Vec<u8>>> = Lazy::new(|| {
...
pub(crate) static BN254_GT_GENERATOR: Lazy<Option<ark_bn254::Fq12>> = Lazy::new(|| {
...
pub(crate) static BN254_Q12_LENDIAN: Lazy<Option<Vec<u8>>> = Lazy::new(|| {
