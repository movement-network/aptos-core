...
use crate::{
    ...
    natives::cryptography::algebra::{
        ...
        BLS12381_R_SCALAR, BN254_R_SCALAR, E_SERIALIZATION_BLS12381_R_SCALAR_LOAD_FAILED,
...
pub fn deserialize_internal(
    ...
    match (structure_opt, format_opt) {
        ...
        (Some(Structure::BLS12381Gt), Some(SerializationFormat::BLS12381Gt)) => {
            ...
            let r_scalar = BLS12381_R_SCALAR.as_ref().ok_or(SafeNativeError::Abort {
                abort_code: E_SERIALIZATION_BLS12381_R_SCALAR_LOAD_FAILED,
            })?;
