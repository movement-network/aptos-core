...
/// Internal error: failed to construct MultiEd25519 secret key.
#[cfg(feature = "testing")]
const E_MULTI_ED25519_SK_CREATE_FAILED: u64 = 0x0A_0001;
/// Internal error: failed to construct MultiEd25519 public key.
#[cfg(feature = "testing")]
const E_MULTI_ED25519_PK_CREATE_FAILED: u64 = 0x0A_0002;
/// Internal error: failed to deserialize MultiEd25519 secret key.
#[cfg(feature = "testing")]
...
fn native_generate_keys(
    ...
    let group_sk = multi_ed25519::MultiEd25519PrivateKey::new(private_keys, threshold).map_err(
        |_| SafeNativeError::Abort {
            abort_code: E_MULTI_ED25519_SK_CREATE_FAILED,
        },
    )?;
    let group_pk = multi_ed25519::MultiEd25519PublicKey::new(public_keys, threshold).map_err(
        |_| SafeNativeError::Abort {
            abort_code: E_MULTI_ED25519_PK_CREATE_FAILED,
        },
    )?;
    Ok(smallvec![
...
fn native_sign(
    ...
    let group_sk = multi_ed25519::MultiEd25519PrivateKey::try_from(sk_bytes.as_slice()).map_err(
        |_| SafeNativeError::Abort {
            abort_code: E_MULTI_ED25519_SK_DESERIALIZATION_FAILED,
        },
    )?;
