...
fn test_db_indexer_data() {
    ...
    let expected_code = vec![
        ...
        ident_str!("atomic_bridge_initiator"),
        ...
        ident_str!("atomic_bridge_counterparty"),
        ident_str!("ethereum_derivable_account"),
        ident_str!("atomic_bridge_configuration"),
    ...
    let expected_resources = vec![
        ...
        (false, "0x1::governed_gas_pool::GovernedGasPool"),
        ...
        (false, "0x1::governed_gas_pool::GovernedGasPoolExtension"),
